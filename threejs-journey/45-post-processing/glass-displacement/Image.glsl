...
//     * gShaderToy.SetTexture(1, {mSrc:'https://raw.githubusercontent.com/lovelymendel/shadertoy/refs/heads/main/threejs-journey/45-post-processing/normal.png', mType:'texture', mID:1, mSampler:{ filter: 'mipmap', wrap: 'repeat', vflip:'true', srgb:'false', internal:'byte' }});
